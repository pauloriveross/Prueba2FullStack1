package duoc.mecanicos.exception;

import duoc.mecanicos.exception.MecanicoNoEncontradoException;
import duoc.mecanicos.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MecanicoNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> manejarMecanicoNoEncontrado(MecanicoNoEncontradoException ex,
