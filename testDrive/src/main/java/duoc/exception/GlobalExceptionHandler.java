package duoc.exception;


import duoc.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({IdVehiculoNoEncontradoException.class,
            ...
            TestDriveNoEncotradoException.class})
    ...
    public ResponseEntity<ErrorResponse> ManejarIdVehiculoDuplicado(IdVehiculoDuplicadoException ex,
        ...
        log.warn("Error al agendar el TestDrive. El vehiculo ya se encuentra agendado {}: {}", request.getRequestURI(), ex.getMessage());
