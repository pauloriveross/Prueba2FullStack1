package duoc.vendedor.exception;
import duoc.vendedor.dto.ErrorResponse;
...
public class GlobalExceptionHandler  {
    ...
    @ExceptionHandler(VendedorNoEncontrado.class)
    public ResponseEntity<ErrorResponse> ManejarVendedorNoEncontrado(VendedorNoEncontrado ex,
                                                                     HttpServletRequest request) {
    ...
    @ExceptionHandler(RutDuplicadoVendedor.class)
    public ResponseEntity<ErrorResponse> ManejarRutDuplicadoVendedor(RutDuplicadoVendedor ex,
                                                                     HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
