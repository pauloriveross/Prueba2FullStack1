...
import duoc.corredorSeguro.dto.ErrorResponse;
...
public class GlobalExceptionHandler  {
    ...
    @ExceptionHandler(CorredorNoEncontrado.class)
    public ResponseEntity<ErrorResponse> ManejarCorredorNoEncontrado(CorredorNoEncontrado ex,
                                                                     HttpServletRequest request) {
    ...
    @ExceptionHandler(RutDuplicadoCorredor.class)
    public ResponseEntity<ErrorResponse> ManejarRutDuplicadoCorredor(RutDuplicadoCorredor ex,
                                                                     HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
