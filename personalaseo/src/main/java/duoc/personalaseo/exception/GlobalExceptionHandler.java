package duoc.personalaseo.exception;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.web.bind.annotation.RestControllerAdvice;

import duoc.personalaseo.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PersonalAseoNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> manejarPersonalAseoNoEncontrado(PersonalAseoNoEncontradoException ex,
    ...
    public ResponseEntity<ErrorResponse> ManejarRutDuplicadoPersonalAseo(RutDuplicadoException ex,
                                                                           HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
